    ...
    return (
      <div className="gp-container pb-28 pt-6">
        <EmptyState
          ...
          action={<Button variant="primary" onClick={() => navigate('/cook/dashboard')}>Dashboard</Button>}
        />
      </div>
    )
  }
  ...
  return (
    <div className="gp-container pb-28 pt-6 md:pb-10">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <Link to="/cook/dashboard" className="text-sm font-semibold text-gp-secondary hover:underline">
          Back to dashboard
        </Link>
      </div>
